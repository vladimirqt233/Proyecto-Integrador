...
@Component({
    selector: 'app-registroenvio-list',
        ...
        <div class="w-full mx-auto p-6 bg-white rounded overflow-hidden shadow-lg">
            ...
            <div class="flex justify-between items-center mb-2 bg-slate-300 text-black p-4 rounded">
                <h2 class="text-2xl font-bold">
                    Lista de <span class="text-primary">Registros</span>
                </h2>
            ...
            <div class="bg-white rounded overflow-hidden shadow-lg">
                <div class="p-2 overflow-scroll px-0">
                    <table class="w-full table-fixed">
                        ...
                        <tbody
                            class="bg-white"
                            *ngFor="let r of registroenvios; let i = index">
...
export class RegistroenvioListComponent implements OnInit {
    abcForms: any;
    @Input() registroenvios: RegistroEnvio[] = [];
