...
@Component({
    selector: 'app-registroenvio-edit',
    standalone: true,
    imports: [FormsModule,
        MatIconModule,
        MatButtonModule,
...
export class RegistroenvioEditComponent implements OnInit {
    registroenvioForm = new FormGroup({
        titulo: new FormControl('', [Validators.required]),
        descripcion: new FormControl('', [Validators.required]),
        fecha: new FormControl('', [Validators.required]),
        vehiculoId: new FormControl<number | null>(null, [Validators.required]), // Acepta números
        clienteId: new FormControl<number | null>(null, [Validators.required]), // Acepta números
        estadoEnvio: new FormControl('', [Validators.required]),
    });
    @Input() title: string = '';
    @Input() registroenvio = new RegistroEnvio();
    abcForms: any;

    constructor(
        private formBuilder: FormBuilder,
        private _matDialog: MatDialogRef<RegistroenvioEditComponent>,
    ) {
    }
    ...
    ngOnInit() {
        ...
        if (this.registroenvio) {
            console.log(this.registroenvio);
            this.registroenvioForm.patchValue(this.registroenvio);
        }
    }
